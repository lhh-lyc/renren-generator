...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("template/CController.java.vm");
        templates.add("template/CEntity.java.vm");
        templates.add("template/CService.java.vm");
...
/*        if (StringUtils.isNotBlank(packageName)) {
        ...
        if (template.contains("CController.java.vm")) {
            return "main" + File.separator + "resources" + File.separator + "up" + File.separator + "controller" + File.separator + className + "Controller.java";
        }

        if (template.contains("CEntity.java.vm")) {
            return "main" + File.separator + "resources" + File.separator + "up" + File.separator + "entity" + File.separator + className + "Entity.java";
        }

        if (template.contains("CService.java.vm")) {
            return "main" + File.separator + "resources" + File.separator + "up" + File.separator + "service" + File.separator + className + "Service.java";
        }
        ...
        if (template.contains("Feign.java.vm")) {
            return "main" + File.separator + "resources" + File.separator + "up" + File.separator + className + "Feign.java";
        }
        ...
        if (template.contains("list.html.vm")) {
            return "main" + File.separator + "page" + File.separator + className.toLowerCase() + ".html";
        }

        if (template.contains("list.js.vm")) {
            return "main" + File.separator + "page" + File.separator + className.toLowerCase() + ".js";
        }

/*        if (template.contains("list.html.vm" )) {
            return "main" + File.separator + "page" + File.separator + "adminlte" + File.separator
